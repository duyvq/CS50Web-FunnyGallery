# Generated by Django 4.1 on 2022-11-04 10:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('commentContent', models.CharField(max_length=8000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('replyContent', models.CharField(max_length=8000)),
                ('timeStamp', models.DateTimeField(auto_now_add=True)),
                ('replyTo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gallery.comment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photoName', models.CharField(max_length=80)),
                ('picture', models.ImageField(upload_to=gallery.models.Photo.item_directory_path)),
                ('photoDescription', models.CharField(blank=True, max_length=700)),
                ('timeStamp', models.DateTimeField(auto_now_add=True)),
